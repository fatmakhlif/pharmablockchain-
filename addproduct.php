...
<html lang="en">
  ...
  $("#aboutbtn").on("click", function(){
      showAlert("Pharmablock is an  Application where customers can easily scan product's QR CODE and get complete information about the provenance of that product .");
  });
