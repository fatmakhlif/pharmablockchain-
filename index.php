  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4> Welcome to PharmaBlock </h4>
            <p style="max-width: 80%;">
            Pharmablock is an  Application where customers can easily scan product's QR CODE and get complete information about the provenance of that product.
            </p>
